...
**Save plans to:** `.pi/craft/YYYY-MM-DD-<topic>/plans.md`
...
**"Plan complete and saved to `.pi/craft/<date-topic>/plan.md`. Ready to implement. I'll use the executing-plans skill to work through each task."**

Then load the executing-plans skill to begin implementation.
